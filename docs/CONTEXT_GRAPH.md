...
_Auto-generated by `scripts/context_graph.py` on 2026-09-26 at commit `2300557`. Do not edit by hand — regenerate with `python3 scripts/context_graph.py` (a pre-commit hook keeps it current)._
...
|---|---|---|---|
| `2300557` | 2026-09-26 | docs: deploy guide and env tooling match the real production setup | backend services/embedding_service, docs, ingestion, repo root, scripts |
| `dad9bf7` | 2026-09-26 | release: advertise APK v1.7; hand prayer location to the native alarm refresher | docs, frontend misc, hooks/useSalah, ingestion, lib/native-bridge |
| `39f9ff0` | 2026-09-26 | fix: home no longer jumps while loading; stale-response races, a11y, SEO accuracy | components, docs, frontend misc, lib/i18n, lib/media-session, lib/seo, page /about, page /account, page /adhkar, page /hadith, page /hadith-of-day, page /khutba, page /library, page /quran, page /recite |
| `033a3eb` | 2026-09-26 | fix: retrieval ranks the right sources across verses, hadith and tafsir | backend misc, backend services/cache, backend services/keyword_search, backend services/query_expansion, docs, ingestion |
| `b50ae00` | 2026-09-26 | fix: version the chat answer cache so answers from the old retrieval stop serving | backend services/cache, docs |
