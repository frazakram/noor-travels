...
_Auto-generated by `scripts/context_graph.py` on 2026-09-26 at commit `39f9ff0`. Do not edit by hand — regenerate with `python3 scripts/context_graph.py` (a pre-commit hook keeps it current)._
