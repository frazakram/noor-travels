...
_Auto-generated by `scripts/context_graph.py` on 2026-07-30 at commit `7bf026c`. Do not edit by hand — regenerate with `python3 scripts/context_graph.py` (a pre-commit hook keeps it current)._
