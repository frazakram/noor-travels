...
_Auto-generated by `scripts/context_graph.py` on 2026-08-16 at commit `7c5a496`. Do not edit by hand — regenerate with `python3 scripts/context_graph.py` (a pre-commit hook keeps it current)._
...
_Stats: 23 frontend routes · 11 backend routers · 15 services · 36 lib modules._
