...
_Auto-generated by `scripts/context_graph.py` on 2026-08-16 at commit `557f0a6`. Do not edit by hand — regenerate with `python3 scripts/context_graph.py` (a pre-commit hook keeps it current)._
...
| `/about` | `lib/api`, `lib/featured-verses`, `lib/i18n`, `lib/quran-display`, `lib/salah`, `lib/seo`, `lib/user-prefs` | `/api/quran` |
