...
_Auto-generated by `scripts/context_graph.py` on 2026-07-29 at commit `33e5aee`. Do not edit by hand — regenerate with `python3 scripts/context_graph.py` (a pre-commit hook keeps it current)._
