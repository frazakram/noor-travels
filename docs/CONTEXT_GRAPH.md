...
_Auto-generated by `scripts/context_graph.py` on 2026-08-06 at commit `3801e6b`. Do not edit by hand — regenerate with `python3 scripts/context_graph.py` (a pre-commit hook keeps it current)._
...
_Stats: 22 frontend routes · 11 backend routers · 12 services · 32 lib modules._
