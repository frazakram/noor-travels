...
_Auto-generated by `scripts/context_graph.py` on 2026-07-29 at commit `0a8c028`. Do not edit by hand — regenerate with `python3 scripts/context_graph.py` (a pre-commit hook keeps it current)._
...
| `/hadith-of-day` | `lib/api`, `lib/hadith-library`, `lib/hadith-topics`, `lib/i18n`, `lib/seo`, `lib/user-prefs` | `/api/hadith` |
...
| `/library` | `lib/i18n`, `lib/seo`, `lib/user-prefs` | — |
| `/quran` | `lib/api`, `lib/i18n`, `lib/quran-bookmarks`, `lib/quran-display`, `lib/seo`, `lib/user-prefs` | `/api/quran` |
| `/quran/[surah]` | `hooks/useSurahAudio`, `lib/api`, `lib/i18n`, `lib/quran-bookmarks`, `lib/quran-display`, `lib/quran-types`, `lib/seo`, `lib/surah-meta`, `lib/tafsir`, `lib/user-prefs` | `/api/quran` |
| `/quran/listen` | — | — |
| `/quran/listen/[surah]` | — | — |
...
| `f2a6410` | 2026-07-04 | Match live khutba in Arabic and suggest fuzzy English matches. | backend api/khutba, backend services/khutbah_match, lib/i18n, page /khutba |
| `607b713` | 2026-07-04 | Fail live khutba with a clear 503 when the Deepgram key is unset. | backend api/khutba |

_Stats: 20 frontend routes · 11 backend routers · 12 services · 25 lib modules._
