...
_Auto-generated by `scripts/context_graph.py` on 2026-08-16 at commit `b0ac498`. Do not edit by hand — regenerate with `python3 scripts/context_graph.py` (a pre-commit hook keeps it current)._
